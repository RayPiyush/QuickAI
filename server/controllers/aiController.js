...
export const generateImage=async(req,res)=>{
    try{
        ...
        res.json({
            success:true,content:secure_url
        })
...
export const resumeReview=async(req,res)=>{
    try{
        ...
        const prompt=`Review the following resume and provide constructive feedback on its strenths,weaknesses, and areas for the improvement.
            Resume content:\n\n${pdfData.text}`
